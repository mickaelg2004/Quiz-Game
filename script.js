document.addEventListener('DOMContentLoaded', () => {
    ...
    function selectAnswer(selectedButton, correctAnswer, answers) {
        ...
        if (decodeHTML(selectedButton.innerHTML) === decodeHTML(correctAnswer)) {
            ...
            resultContainer.innerText = `Errouu, errou feio, errou rude! o certo era: ${decodeHTML(correctAnswer)}`;
        }
    ...
    function updateProgress() {
        progressContainer.innerText = `Questão ${questionIndex + 1}/${currentQuestions.length}`;
    }
